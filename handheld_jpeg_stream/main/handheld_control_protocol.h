...
#define HANDHELD_CONTROL_FLAG_TELEPORT_BUTTON_HELD     UINT8_C(0x02)
#define HANDHELD_CONTROL_FLAG_HEIGHT_CYCLE_BUTTON_HELD UINT8_C(0x04)
...
typedef struct {
    ...
    uint32_t session_id;
    uint32_t sample_seq;
    uint32_t event_seq; /* RFHC v1 retained field; transmit as zero. */
