...
$buildDirectory = Join-Path $projectDirectory "build-bno-lcd"
$sdkconfigPath = Join-Path $projectDirectory "sdkconfig.bno_lcd"
$defaultsPath = "sdkconfig.defaults;sdkconfig.bno_lcd.defaults"
